...
public class AppInfo {
  ...
  public static String getAppVersion() {
    CommandResult cr =
        ShellUtils.execCommand("adb shell dumpsys package " + appPackageName + "|grep versionName");
    for (String str : cr.getSuccessMsgArray()) {
  ...
  public static void clearAppData(String appPackageName) {
    CommandResult cr =
        ShellUtils.execCommand(StringUtils.join("adb shell pm clear ", appPackageName));
