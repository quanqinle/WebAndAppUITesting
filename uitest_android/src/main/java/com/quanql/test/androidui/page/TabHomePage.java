...
public class TabHomePage extends MainFramePage {
	...
	public static void clickBrand(FlowTask flowTask) {
		...
		LogUtil.info("查找品牌");
		MobileElement element = baseOpt.scrollToView(By.id(viMainContentId), By.id(tvBrandtitleId), 0, 8); // 滚动10屏
	...
	public static boolean tabHomePageCheck() {
		...
		WebElement brand = baseOpt.scrollToView(By.id(viMainContentId), By.id(getObfuscatedID("iv_banner")), 0, 8);
